...
@if $create-font-face == true {
  @font-face {
   ...
   src: url('../../assets/fonts/icons/__FAMILY__.eot'); /* IE9 Compat Modes */
   src: url('../../assets/fonts/icons/__FAMILY__.woff') format('woff'), /* Pretty Modern Browsers */
      url('../../assets/fonts/icons/__FAMILY__.ttf')  format('truetype'), /* Safari, Android, iOS */
      url('../../assets/fonts/icons/__FAMILY__.svg') format('svg'); /* Legacy iOS */
  }
}
